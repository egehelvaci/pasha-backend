...
### 2. Kullanıcı Bildirimlerini Getir
```http
GET /api/notifications/user/{userId}?page=1&limit=20&unreadOnly=false
  ...
  "data": [
    {
      ...
      "userId": "user_123",
      "title": "Sipariş Onaylandı",
      "message": "ORD-2024-001 numaralı siparişiniz onaylandı",
      "type": "ORDER_CONFIRMED",
      "orderId": "order_456",
...
### 5. Tüm Bildirimleri Okundu İşaretle
```http
